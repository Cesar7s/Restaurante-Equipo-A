...
SECCION DE PEDIDOS: Este es el script de base de datos en MYSQL para poder operar los pedidos en los diferentes casos de uso.
...
-- Solo necesitamos el precio del producto que viene como parámetro
